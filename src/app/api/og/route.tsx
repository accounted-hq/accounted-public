...
export async function GET(req: NextRequest) {
  try {
    ...
    // Convert OKLCH to RGB approximations for better OG compatibility
    const colors = {
      background: '#ffffff', // oklch(1 0 0)
      foreground: '#1e293b', // oklch(0.141 0.005 285.823) 
      primary: '#7c3aed', // oklch(0.623 0.214 259.815) - purple
      primaryForeground: '#f8fafc', // oklch(0.97 0.014 254.604)
      muted: '#f8fafc', // oklch(0.967 0.001 286.375)
    ...
    return new ImageResponse(
      (
        <div
          style={{
            ...
            padding: '64px',
            background: `linear-gradient(135deg, ${colors.background}, ${colors.muted})`,
      ...
      ),
      {
        ...
        fonts: [
            {
              name: 'Nunito',
              data: await loadGoogleFont('Nunito', site.name), /* title */
              style: 'normal',
            },
            {
                name: 'Nunito Sans',
                data: await loadGoogleFont('Nunito Sans', site.tagline), /* subtitle, badges, new URL(site.baseUrl).host */
                style: 'normal',
            },
        ],
